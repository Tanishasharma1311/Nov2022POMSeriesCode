...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName, String email, String telephone, String password, String subscribe) {
		...
		String sucessMesg = eleUtil.WaitForElementVisible(registerSuccessMesg, AppConstants.DEFAULT_MEDIUM_TIME_OUT).getText();
		System.out.println("user success messg : " + sucessMesg);
		if(sucessMesg.contains(AppConstants.USER_REG_SUCCESS_MESSG)) {
